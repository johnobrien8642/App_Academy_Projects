...
/***/ function(module, exports) {
  ...
  //your code here!
    $('.square').css('background-color', '#FFA500');
	};
  ...
  //your code here! 
    $('div ul:last-child').append('<h1></h1>').text('i love jquery')
	};
  ...
  //your code here!
    $('.square:nth-child(even)').append('<strong></strong>').text('John OBrien')
	};
  ...
  //your code here!
    ...
    $('.square').on('click', function(event){
      ...
      const $dogPos = $squareLi.data('pos')
      alert($dogPos)
    });
  ...
  //your code here!
    ...
    $('.square').on('mouseover', function(event){
      ...
      const $squareRGB = $squareLi.css('background-color')
      alert($squareRGB)
    });
	};
