...
const mutation = new GraphQLObjectType({
  ...
  fields: {
    ...
    addWand: {
      ...
      resolve(parentValue, { wizardId, wood, length, core }) {
        return axios
          .post("http://localhost:3000/wands", { wizardId, wood, length, core })
          .then(res => res.data)
      }
    },
    updateWand: {
      ...
      args: {
        id: { type: new GraphQLNonNull(GraphQLInt) },
        wizardId: { type: GraphQLInt },
        wood: { type: GraphQLString },
        length: { type: GraphQLInt },
        core: { type: GraphQLString },
      },
      resolve(parentValue, { id, wizardId, wood, length, core }) {
        return axios
          .patch(`http://localhost:3000/wands/${id}`, { wizardId, wood, length, core })
          .then(res => res.data)
      }
    },
    deleteWand: {
      ...
      resolve(parentValue, { id }) {
        return axios
          .delete(`http://localhost:3000/wands/${id}`)
          .then(res => res.data)
      }
    },
...
//   args: {
//     id: { type: new GraphQLNonNull(GraphQLInt) },
//     wizard: { type: GraphQLString },
//     wood: { type: GraphQLString },
//     length: { type: GraphQLInt },
//     core: { type: GraphQLString },
//   },
//   resolve(parentValue, { wizard, wood, length, core }) {
//     return axios
//       .post("http://localhost:3000/wands", { wizard, wood, length, core })
//       .then(res => res.data)
//   }
// },
// deleteWand: {
